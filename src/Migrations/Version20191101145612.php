 ...
 */
final class Version20191101145612 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX matches ON mapping (shopify_url, stockx_url)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX matches ON mapping');
